import sys
from PyQt6.QtWidgets import QApplication, QDialog, QMessageBox, QMainWindow, QWidget, QGridLayout, QLabel, QLineEdit, QPushButton, QVBoxLayout, QHBoxLayout, QGraphicsScene, QGraphicsView, QGraphicsRectItem, QGraphicsTextItem, QGraphicsLineItem
...
class MainMenu(QMainWindow):
    ...
    def on_start_button_click(self):
        ...
        try:
            ...
            QMessageBox.critical(self, "Invalid Input", "Please enter valid integer values for m, n, and k.")
            return
...
class GameBoardWindow(QMainWindow):
    ...
    def on_button_clicked(self, i, j):
        current_player = self.game.get_current_player()
        if not isinstance(current_player, (Bot_random, Bot_simple, Bot_simple_v2, Bot_complex)):
    ...
    def handle_bot_move(self):
        ...
        if isinstance(current_player, (Bot_random, Bot_simple, Bot_simple_v2, Bot_complex)):
